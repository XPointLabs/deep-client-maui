...
public sealed class MailboxRuntimeProvisioningPathTests
{
    ...
    [Fact]
    public void LegacyPrivacyRouteParserIsRemoved()
    {
        Assert.Null(typeof(MailboxRuntimeProvisioning).GetMethod(
            "ParsePrivacyRoutes",
    ...
    {
        var encoded = Encoding.UTF8.GetBytes("opaque-deprecated-route-artifact");
